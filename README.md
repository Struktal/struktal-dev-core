...
However, if you choose to require this wrapper "library", you will receive less update notifications for Pest, and with each update, you will be informed if there are any breaking changes in connection with the Struktal framework, and how they can be resolved.
